...
import com.test.breakout.breakoutgame.game.Constants;
import com.test.breakout.breakoutgame.game.Constants.BallDirection;
...
public class Ball extends Quad {
	...
	private float getX2InEquation(float x1, float y1, float y2)
	{
	 ...
	 // angle of incidence (relative to the Y axis) of the ball's trajectory.
	public float getAngle() {
		//getting absolute value as angle od slope can be negative
	...
	private BallDirection getDirection() {
	 ...
	 // reflection of the previous position point across the axis that is perpendicular to the surface of the object to which the
